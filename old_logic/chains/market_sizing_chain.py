...
# Remove EXA and Perplexity web search enrichment from the chain
def run_market_sizing_chain(profile: StartupProfile) -> StartupProfile:
    ...
    # Only use context from the profile, no web search
    prompt_vars = {"context": context, "web_context": ""}
...
def run_market_sizing_chain_with_text(full_text: str, profile: StartupProfile) -> StartupProfile:
    ...
    # Only use context from the text, no web search
