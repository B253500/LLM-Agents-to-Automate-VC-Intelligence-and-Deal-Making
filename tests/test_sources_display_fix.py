...
def test_sources_display_fix():
    ...
    profile.web_sources = [
        "[Crunchbase](https://www.crunchbase.com/organization/storedot)",
        "[TechCrunch](https://techcrunch.com/2022/01/18/storedot-raises-70m-series-d-round-led-by-vinfast/)"
    ]
    ...
    profile.web_sources = [
        ...
        "https://techcrunch.com/2022/01/18/storedot-raises-70m-series-d-round-led-by-vinfast/"
    ]
    ...
    profile.web_sources = [
        "[Crunchbase](https://www.crunchbase.com/organization/storedot)",
        "https://techcrunch.com/2022/01/18/storedot-raises-70m-series-d-round-led-by-vinfast/",
        "https://www.linkedin.com/company/storedot"
    ]
