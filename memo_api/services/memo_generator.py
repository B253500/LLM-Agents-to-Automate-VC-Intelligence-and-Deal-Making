...
<body>
    ...
    <div class="front-page">
        <img src="logo/front_page.png" class="front-logo" alt="Front Page Logo"/>
        <div class="front-phrase">This Investment Memo for <span class="front-company">{company_profile.get('name', 'the company')}</span> was Automatically Generated by the VC Intelligence System</div>
        <div style="font-size:1.1em; color:#888; margin-top:30px;">Prepared on {datetime.now().strftime('%B %d, %Y')}</div>
    </div>
    <div class="page-break"></div>
    <!-- Main Content -->
    <div class="container">
        <img src="logo/uni_logo.png" class="header-logo" alt="Header Logo"/>
        <div class="header">
            <h1><b>Investment Memorandum</b></h1>
            <div class="subtitle"><b>{company_profile.get('name', 'Company')}</b> - <b>{company_profile.get('sector', 'Sector')}</b></div>
            <div class="subtitle">Generated on {datetime.now().strftime('%B %d, %Y at %I:%M %p')}</div>
        </div>
        <div class="section">
            <h2><b>Executive Summary</b></h2>
            <div style="margin-bottom: 10px;">{meta.get('executiveSummary', 'A comprehensive summary of the company, opportunity, and key highlights will appear here.')}</div>
            ...
            <div style="margin-top: 10px; font-size: 0.95em; color: #888;">Sources: {meta.get('sources', 'Company documents, market research, competitive intelligence, technical analysis')}</div>
        </div>

        <div class="section">
            <h2><b>Market Opportunity & Sizing</b></h2>
            <div class="metrics-grid">
                <div class="metric-card">
        ...
        <div class="section">
            <h2><b>Technical Due Diligence</b></h2>
            <div class="metrics-grid">
                <div class="metric-card">
        ...
        <div class="section">
            <h2><b>Team & Founder Analysis</b></h2>
            <div style="margin-top: 20px;">
        ...
        <div class="section">
            <h2><b>Competitive Intelligence</b></h2>
            <div style="margin-top: 20px;">
