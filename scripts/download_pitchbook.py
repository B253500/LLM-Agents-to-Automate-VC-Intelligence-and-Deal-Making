    ...
    for listing_url in REPORT_LISTING_URLS:
        ...
        for du in detail_urls:
            ...
            try:
                ...
                page2.wait_for_selector("input[name='FirstName']", timeout=20000)
                ...
                submit_btn = page2.wait_for_selector("input[type='submit'][value='Download report']:not([disabled]), input[type='submit'][value='Download']:not([disabled])", timeout=30000)
                ...
                try:
                    with page2.context.expect_page(timeout=30000) as popup_info:
                    ...
                    try:
                        ...
                        with page2.expect_download(timeout=30000) as download_info:
                            pass  # The click has already been performed
