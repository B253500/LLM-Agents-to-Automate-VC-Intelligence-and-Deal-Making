...
-----------------------
MARKET ANALYSIS
{crewai_outputs['market_analysis']}

COMPETITOR ANALYSIS
{crewai_outputs['competitor_analysis']}
...
if __name__ == "__main__":
    ...
    deck_memo, market_opportunity, profile = run_deck_analysis(pdf_path)
    ...
    # 4. Format combined memo content (enhanced)
